...
def main():
    ...
    if event == "UserPromptSubmit":
        # User just sent a message - Codex is now processing
        ...
        # No response or "ask" - let Codex CLI show its normal UI
        sys.exit(0)
