...
def get_tty():
    """Get the TTY of the OpenCode process (parent)"""
    import subprocess

    # Get parent PID (OpenCode process)
    ppid = os.getppid()
...
def main():
    ...
    if event == "UserPromptSubmit":
        # User just sent a message - OpenCode is now processing
